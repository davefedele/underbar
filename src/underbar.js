...
(function() {
  ...
  _.every = function(collection, iterator) {
    ...
    return Boolean(_.reduce(collection, function(isTrue, item){
      ...
      else if (iterator === undefined ? item : iterator(item)) {
        return true;
      }
      else {
        return false;
  ...
  _.memoize = function(func) {
    ...
    var result = function() {
      if (cache[arguments[0]]) {
        ...
        return cache[arguments[0]] = func.apply(null, arguments);
      }
    };
  ...
  _.shuffle = function(array) {
    ...
    for (var i=result.length-1; i>=0; i--) {
      ...
      var randomItem  = Math.floor(Math.random() * result.length);

      result[i] = result[randomItem];
      result[randomItem] = currentItem;
    }
  return result;
  };
